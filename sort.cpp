...
signed main() {
	do{
		cout << "��ӭʹ�� ���ӻ����� v1.0 by Skyfire" << endl;
		cout << "������ϣ�����ɵ����ݸ��� (30, 200) ���������ֵ (5, 50): " << endl;
		cin >> MAXN >> MAXM;
		system("cls");
	...
	do{
		...
		cout << "1. ð������ (O(n^2 ~ n^2) �ȶ�)" << endl;
		cout << "2. ѡ������ (O(n^2 ~ n^2) ���ȶ�)" << endl;
		cout << "3. �������� (O(n^2 ~ n^2) �ȶ�)" << endl;
		cout << "4. ϣ������ (O(n^1.5 ~ n^1.5) ���ȶ�)" << endl;
		cout << "5. �������� (O(nlogn ~ n^2) ���ȶ�)" << endl;
		cout << "6. �鲢���� (O(nlogn ~ nlogn) �ȶ�)" << endl;
		cout << "7. �������� (O(1 ~ inf) ���ȶ�)" << endl;
		cin >> mode;
		system("cls");
	}while(mode < 1 || mode > 7);
	init();
